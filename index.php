...
<body>
        ...
        <div id="header">
            ...
            <div class="social-media-links">
               <a href="https://www.instagram.com/v.nuja/"><img src="images/instagram logo.png" class="social-media" alt="instagram-logo"></a><!--Your instagram homepage link inser in place of "#"-->
                <a href="https://web.facebook.com/vinuja.ransith/"><img src="images/facebook logo.png" class="social-media" alt="facebook-logo"></a>
                <a href="https://www.linkedin.com/in/vnuja/"><img src="images/linkedin logo.png" class="social-media" alt="linkedin-logo"></a>
                <a href="https://x.com/v_nuja"><img src="images/twitter logo.png" class="social-media" alt="twitter-logo"></a>
                <a href="https://www.tiktok.com/@v.nuja"><img src="images/tiktok.png" class="social-media" alt="tiktok-logo"></a>
                <a href="https://wa.me/+94769451554"><img src="images/whatsapp.png" class="social-media" alt="wp-logo"></a>
            ...
            <div class="header-content">
                ...
                <div class="firstline"><span class="color">Vinuja </span>Ransith</div>
                <div class="secondline">
                I'm a
            <span class="txt-rotate color" data-period="1200"data-rotate='[ " Content Creator.", " SE Project Manager. ", " Web Designer.", " Software Designer.", " Hardware Supervisor." ]'></span>
            <span class="slash">|</span>
        </div>
                    <div class="contact">
                <a href="Mailto:vinujaransith039@gmail.com"><img src="images/mail.png" alt="email-pic" class="contactpic"></a><!--Your email Id write in place of "#"-->
                <a href="Tel:+94769451554"><img src="images/call.png" alt="phone-pic" class="contactpic"></a><!--Your telephone number Id write in place of "#"-->
                    </div>    
            </div>
            </div>
            <!--header image-->
        ...
        <div id="about">
            ...
            <!--about description-->
               <span class="about-first-line"> 
                    <span class="color">As an ambitious undergraduate student at SLIIT University, I am passionate about technology and digital innovation.</span>
                    My academic journey is complemented by hands-on experience in marketing and social media design, where I have honed my skills in a professional setting. </span>
                     <br>
               <span>  

                Professional Experience:<br>
                <br>
                Marketing Assistant Intern at Iplay.lk:<br> Here, I developed my understanding of marketing strategies and gained practical experience in executing marketing campaigns.<br>
                Social Media Designer Intern at MSI:<br> This role allowed me to creatively engage with audiences and design impactful social media content.<br>
                <br>
                Key Skills:<br>
                <br>
                Programming Languages: I have a foundational knowledge of HTML, CSS, JavaScript, PHP, Java, C, C++, SQL, and Arduino, which I continually seek to expand.<br>
                Adobe Creative Suite: Proficient in Adobe Premiere Pro (PR) and Photoshop (PS), I leverage these tools to create compelling digital content.<br>
                <br>
                Achievements:<br>
                <br>
                Successfully developed fully functional systems for smart homes, vehicles, and computers, demonstrating my ability to integrate technology into everyday applications.<br>
                Education and Certifications:<br>
                01. GCE O/L<br>
                02. GCE A/L<br>
                03. IHRA English Diploma at Colombo University<br>
                04. IHRA IT Diploma at Colombo University<br>
                <br>
                Personal Touch:<br>
                <br>
                Outside of academics and internships, I am an avid gamer, content creator, and vlogger. These hobbies not only fuel my creativity but also keep me connected with the latest trends in digital media and technology</span>
               <div class="cv">
    ...
    <!--copyright-section You Can Remove After Downloading-->
            <div class="footer">
             <div class="footer-text">
                 <img src="./images/copyright.png" alt="copyright-img" class="images" height="14px"> Vinuja Ransith 2024!
             </div>
            </div>
    <!--copyright-section-->
        </div>
            ...
            <!--Contact information-->
             <div class="contact-info">
              ...
              <div class="contect-info-content-line">
                  ...
                  <div class="contact-info-icon-text">
                      <h6>Email</h6>
                      <p>vinujaransith039@gmail.com</p>
                </div>
              </div>
                </div>
